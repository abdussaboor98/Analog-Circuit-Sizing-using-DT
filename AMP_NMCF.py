...
PWD = os.getcwd()
#SPICE_NETLIST_DIR = f'/simulations'
...
class AMPNMCFEnv(gym.Env, CktGraph, DeviceParams):
    ...
    def _do_simulation(self, action: np.array):
        ...
        try:
            ...
            AMP_NMCF_vars.close()
            os.system(f'cd {SPICE_NETLIST_DIR}&& ngspice -b -o AMP_NMCF_ACDC.log AMP_NMCF_ACDC.cir > /dev/null 2>&1')
            os.system(f'cd {SPICE_NETLIST_DIR}&& ngspice -b -o AMP_NMCF_Tran.log AMP_NMCF_Tran.cir > /dev/null 2>&1')
